...
import net.oriondev.mattocks2.mattock_type.BotchedToolMaterialsEnderite;
...
public class Mattocks2 implements ModInitializer {
	...
	public static final Mattock ENDERITE_MATTOCK = new Mattock(7, -3, new BotchedToolMaterialsEnderite(), new Item.Settings().group(ItemGroup.TOOLS).fireproof());
